 ...
 */
function RetroC64PlayerStatsUiScene(parameterObject) {
...
RetroC64PlayerStatsUiScene.prototype = Object.create(UiScene.prototype);
RetroC64PlayerStatsUiScene.prototype.constructor = UiScene;
{ // RetroC64PlayerStatsUiScene Getters/Setters
}
/**
 * Starts the scene.
 */
RetroC64PlayerStatsUiScene.prototype.startScene = function() {
 ...
 */
RetroC64PlayerStatsUiScene.prototype.init = function(data) {
}
/**
 ...
 */
RetroC64PlayerStatsUiScene.prototype.preload = function() {
}
/**
 ...
 * @param {object} data Any data passed via ScenePlugin.add() or ScenePlugin.start(). Same as Scene.settings.data.
 */
RetroC64PlayerStatsUiScene.prototype.create = function(data) {
  // call base
 ...
 */
RetroC64PlayerStatsUiScene.prototype.update = function(time, delta) {
  // call base
 ...
 */
RetroC64PlayerStatsUiScene.prototype.handleKeyUpEvent = function(event) {
 ...
 */
RetroC64PlayerStatsUiScene.prototype.watchUpdated = function(data) {
  // call base
...
if (typeof(module) !== "undefined") {
  module.exports = { RetroC64PlayerStatsUiScene };
}

 ...
 */
function RetroC64AkalabethShopInventoryInterface(parameterObject) {
  parameterObject.columns = 8;
  parameterObject.rows = 24;
  UiScene.call(this, parameterObject); // call parent constructor

  { // RetroC64AkalabethShopInventoryInterface View Templates
  ...
  { // RetroC64AkalabethShopInventoryInterface Key Listener Handlers
...
RetroC64AkalabethShopInventoryInterface.prototype = Object.create(UiScene.prototype);
RetroC64AkalabethShopInventoryInterface.prototype.constructor = UiScene;
{ // RetroC64AkalabethShopInventoryInterface Getters/Setters
}
/**
 * Starts the scene.
 */
RetroC64AkalabethShopInventoryInterface.prototype.startScene = function() {
...
{ // RetroC64AkalabethShopInventoryInterface Scene Extensions
  /**
   * This method is called by the Scene Manager when the scene starts, before preload() and create().
     * @param {object} data Any data passed via ScenePlugin.add() or ScenePlugin.start(). Same as Scene.settings.data.
 */
  RetroC64AkalabethShopInventoryInterface.prototype.init = function(data) {
  }
  /**
   ...
   */
  RetroC64AkalabethShopInventoryInterface.prototype.preload = function() {
  }
  /**
   ...
   * @param {object} data Any data passed via ScenePlugin.add() or ScenePlugin.start(). Same as Scene.settings.data.
   */
  RetroC64AkalabethShopInventoryInterface.prototype.create = function(data) {
    // call base
   ...
   */
  RetroC64AkalabethShopInventoryInterface.prototype.update = function(time, delta) {
    // call base
 ...
 */
RetroC64AkalabethShopInventoryInterface.prototype.handleKeyUpEvent = function(event) {
  this._KEY_UP_EVENT_HANDLERS[this._state](event, this);
}
if (typeof(module) !== "undefined") {
  module.exports = { RetroC64AkalabethShopInventoryInterface };
}

...
var RetroC64ShopScene = (function() {
  ...
  let _shopInventoryUi = new RetroC64ShopInventoryUi({ scene: _scene, show: true });
  /** @private RetroC64ShopCommandsUiScene instance */
  let _shopCommandsUiScene = new RetroC64ShopCommandsUiScene({ scene: _scene, show: true });
  /** @private RetroC64PlayerStatsUiScene instance */
  let _playerStatsUiScene = new RetroC64PlayerStatsUiScene({ scene: _scene, show: true });

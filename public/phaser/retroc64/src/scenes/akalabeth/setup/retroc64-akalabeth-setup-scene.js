if (typeof(module) !== "undefined") {
  var { RetroC64SetupUi } = require("./retroc64-akalabteh-setup-interface");
}
/**
 * @class While the game world is created, a wait screen is displayed.
 */
var RetroC64AkalabethSetupScene = (function() {
  /** @private Scene instance. */
  let _scene = new Phaser.Scene({
    key: "AkalabethSetupScene",
    active: false
  });
  /** @private The current state. */
  let _state = "";
  /** @private RetroC64AkalabethSetupInterface instance */
  let _akalabethSetupInterface = new RetroC64AkalabethSetupInterface({ scene: _scene, show: false });
  /** @private The map of child scenes. */
  const _SCENES = {
    /** @private the scene instances displayed during the setup view */
    [RetroC64Constants.AKALABETH_SETUP]: [_akalabethSetupInterface],
  };
  { // RetroC64AkalabethSetupScene Getters/Setters
  ...
  { // RetroC64AkalabethSetupScene Scene Extensions
    /**
...
if (typeof(module) !== "undefined") {
  module.exports = { RetroC64AkalabethSetupScene };
}

if (typeof(module) !== "undefined") {
  var { RetroC64AkalabethCharacterStatsInterface } = require("../scenes/akalabeth/character-stats/retroc64-akalabeth-character-stats-interface");
}
/**
 * @class The Player can view their character's stats through the Character Stats view.
 */
var RetroC64AkalabethCharacterStatsScene = (function() {
  /** @private Scene instance. */
  let _scene = new Phaser.Scene({
    key: "AkalabethCharacterStatsScene",
    active: false
  });
  /** @private The current state. */
  let _state = "";
  /** @private A private field will be used to track the state to return to from this scene. */
  let _callbackState = RetroC64Constants.AKALABETH_WORLD_MAP;
  /** @private RetroC64AkalabethCharacterStatsInterface instance */
  let _akalabethCharacterStatsInterface = new RetroC64AkalabethCharacterStatsInterface({ scene: _scene, show: true });
  /** @private The map of child scenes. */
  const _SCENES = {
    /** @private the scene instances displayed during the character stats scene */
    [RetroC64Constants.AKALABETH_CHARACTER_STATS_MAIN]: [_akalabethCharacterStatsInterface],
  };
  { // RetroC64AkalabethCharacterStatsScene Getters/Setters
  ...
  { // RetroC64AkalabethCharacterStatsScene Scene Extensions
    /**
...
if (typeof(module) !== "undefined") {
  module.exports = { RetroC64AkalabethCharacterStatsScene };
}

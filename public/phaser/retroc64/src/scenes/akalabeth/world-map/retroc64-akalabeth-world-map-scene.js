if (typeof(module) !== "undefined") {
  var { RetroC64AkalabethWorldMapInterface } = require("./retroc64-akalabeth-world-map-interface");
  var { RetroC64AkalabethWorldMapGraphics } = require("./retroc64-akalabeth-world-map-graphics");
}
/**
...
var RetroC64AkalabethWorldMapScene = (function() {
  ...
  /** @private RetroC64AkalabethWorldMapInterface instance */
  let _akalabethWorldMapInterface = new RetroC64AkalabethWorldMapInterface({ scene: _scene, show: false });
  /** @private RetroC64AkalabethWorldMapGraphics instance */
  let _akalabethWorldMapGraphics = new RetroC64AkalabethWorldMapGraphics({
    cellWidth: 150,
    cellHeight: 150,
    xOffset: -125,
    yOffset: -125,
  ...
  const _SCENES = {
    /** @private the scene instances displayed during the world map view */
    [RetroC64Constants.AKALABETH_WORLD_MAP_DISPLAY]: [_akalabethWorldMapGraphics, _akalabethWorldMapInterface],
  };
  ...
  { // RetroC64AkalabethWorldMapScene Scene Extensions
    /**

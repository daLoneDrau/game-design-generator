if (typeof(module) !== "undefined") {
  var { RetroC64AkalabethGameOverInterface } = require("./retroc64-akalabeth-game-over-interface");
}
/**
 * @class A view to handle the Game Over scene will be needed.
 */
var RetroC64AkalabethGameOverScene = (function() {
  /** @private Scene instance. */
  let _scene = new Phaser.Scene({
    key: "AkalabethGameOverScene",
    active: false
  });
  /** @private The current state. */
  let _state = "";
  /** @private RetroC64AkalabethGameOverInterface instance */
  let _akalabethGameOverInterface = new RetroC64AkalabethGameOverInterface({ scene: _scene, show: false });
  /** @private The map of child scenes. */
  const _SCENES = {
    /** @private the scene instances displayed during the game over view */
    [RetroC64Constants.AKALABETH_GAME_OVER_MAIN]: [_akalabethGameOverInterface],
  };
  { // RetroC64AkalabethGameOverScene Getters/Setters
  ...
  { // RetroC64AkalabethGameOverScene Scene Extensions
    /**
...
if (typeof(module) !== "undefined") {
  module.exports = { RetroC64AkalabethGameOverScene };
}

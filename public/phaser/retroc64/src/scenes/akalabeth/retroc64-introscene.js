if (typeof(module) !== "undefined") {
  ...
  var { RetroC64IntroUi } = require("./intro/retroc64-intro-ui");
}
/**
 * @class The Intro Scene is the first scene displayed when the game starts.
 */
var RetroC64IntroScene = (function() {
  ...
  const _SCENES = {
    ...
    [RetroC64Constants.AKALABETH_INTRO_SHOP]: _uiScene,
    /** @private the scene instance displayed during the character review state */
    [RetroC64Constants.AKALABETH_INTRO_REVIEW_CHARACTER]: _uiScene,
    /** @private the scene instance displayed during the lucky number state */
    [RetroC64Constants.AKALABETH_INTRO_LUCKY_NUMBER]: _uiScene,
  };
  { // RetroC64IntroScene Getters/Setters
...
if (typeof(module) !== "undefined") {
  module.exports = { RetroC64IntroScene };
}

if (typeof(module) !== "undefined") {
  ...
  var { RetroC64SetupUi } = require("../scenes/akalabeth/setup/retroc64-setup-ui");
}
/**
 * @class While the game world is created, a wait screen is displayed.
 */
var RetroC64SetupScene = (function() {
  ...
  const _SCENES = {
    ...
    [RetroC64Constants.AKALABETH_SETUP]: [_setupUi],
  };
  { // RetroC64SetupScene Getters/Setters
...
if (typeof(module) !== "undefined") {
  module.exports = { RetroC64SetupScene };
}

...
const FormManager = (function() {
  ...
  /** @private template for displaying the ADD ENUM form. */
  const _ADD_ENUM = [
    {
      dom: "div",
      class: "modal-header",
    ...
    },
    {
      ...
      callback: {
        "submit": {
          args: "",
          body: "FormManager.submitAddEnumForm(arguments);"
        }
      },
      children: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              attr: {
                type: "text",
                id: "sectionTitleEntry",
                placeholder: "Enter Enum Title"
              },
              callback: {
                keyup: {
                  args: "",
                  body: "$(\"#enumNameEntry\").val($(\"#sectionTitleEntry\").val().replace(/ /gi, \"\").replace(/-/gi, \"\").replace(/!/gi, \"\").replace(/\\?/gi, \"\").replace(/\\&/gi, \"_\"));"
                }
              }
            }
          ]
        ...
        },
        {
          ...
          dom: "div",
          class: "form-group",
          attr: { id: "enumPropertyGroup" },
          children: [
            {
              dom: "label",
              attr: {
                for: "enumWPropertyEntry"
              },
              content: "Enum Property"
            },
            {
              dom: "input",
              class: ["form-select", "enumPropertyName"],
              attr: {
                type: "text",
                id: "enumPropertyName",
            ...
            {
              dom: "<select>", 
              class: ["form-select", "enumPropertyTypeSelect"],
              attr: { id: "enumPropertyTypeSelect" },
              children: [
                {
                  dom: "<option>",
                  attr: {
            ...
            },
            {
              ...
              callback: {
                click: {
                  args: "",
                  body: "FormListener.addAnotherEnumProperty(arguments);"
                }
              }
            }
          ]
  ...
  return {
    ...
    displayDesignSubForm: function() {
      ...
      switch ($("#designSelect option:selected").val()) {
        case "class":
          ...
          break;
        case "enum":
          FormManager.displayAddEnumForm();
          break;
        case "code-injection":
        ...
        case "private field":
          {
            ...
            if (o.classUid.length === 0
              ...
              o.fields = [{
                ...
                fieldDefinition: o.fieldDefinition
              }];
              delete o.fieldName;
              delete o.fieldType;
              delete o.fieldValue;
              delete o.fieldDefinition;
              ProjectManager.addDesign(o);
            }
          }
          break;
        ...
        case "public property":
          {
            ...
            if (o.classUid.length === 0
              ...
              if ($("#getterDefinitionEntry").val().length > 0
                ...
                o.getterBody = $("#getterBodyEntry").val().split("\n");
              }
              if ($("#setterDefinitionEntry").val().length > 0
                  && $("#setterBodyEntry").val().length > 0) {
                o.setterDefinition = $("#setterDefinitionEntry").val();
                o.setterBody = $("#setterBodyEntry").val().split("\n");
              }
    ...
    displayAddEnumForm: function() {
      $(".modal-content").html("");
      for (let i = _ADD_ENUM.length - 1; i >= 0; i--) {
        $(".modal-content").prepend(CONTENT_BUILDER(_ADD_ENUM[i]));
      }
      $("#mainModal").show({ "backdrop": "static", "keyboard": false });
    },
    ...
    submitAddEnumForm: function() {
      $("#mainModal").hide();
      let enumPropertyType = {
        string: "string",
        "string array": {
          fieldType: "array",
          elementType: "string"      
      ...
      arguments[0][0].preventDefault();
      let o = {
        enumName: $("#sectionTitleEntry").val(),
        enumHandle: $("#enumNameEntry").val(),
        tags: ["enum"],
        enumDefinition: $("#sectionContentEntry").val(),
        enumProperties: [],
        weight: $("#enumWeightEntry").val(),
        uid: [Date.now().toString(36), Math.random().toString(36).substr(2)].join(""),
        values: {}
      };
      let properties = $(".enumPropertyName"), propertyTypes = $(".enumPropertyTypeSelect option:selected");
      for (let i = properties.length - 1; i >= 0; i--) {
        let property = $(properties[i]).val();
        let propertyType = $(propertyTypes[i]).val();
        o.enumProperties.push({
          enumFieldName: property,
          type: enumPropertyType[propertyType]
        });
      }
      ProjectManager.addDesign(o);
    },
        ...
        case "prototype":
          {
            ...
            if ($("#watchableEntry").is(":checked")) {
              let uid = [Date.now().toString(36), Math.random().toString(36).substring(2)].join("");
              designObject["constructor body"] = [{
                classUid: classUid,
                tags: ["code", "constructor body"],
              ...
              o.children[1].design.push({ designUid: uid });

              uid = [Date.now().toString(36), Math.random().toString(36).substring(2)].join("");
              designObject["inheritance"] = [{
                classUid: classUid,
                tags: ["code", "inheritance"],
            ...
            ProjectManager.addDesign(designObject);
          }
          break;
        case "prototype test":
          {
...
const FormListener = (function() {
  ...
  return {
    addAnotherEnumProperty: function() {
      let $a = $(arguments[0][0].currentTarget);
      CONTENT_BUILDER({
        dom: "input",
        class: ["form-control", "enumPropertyName"],
        attr: {
          type: "text",
          id: "enumPropertyName",
          placeholder: "Property"
    ...
    selectCodeInjectionClass: function() {
      ...
      let entry = ProjectManager.getDesignEntryByUid($("#classListing option:selected").val());
